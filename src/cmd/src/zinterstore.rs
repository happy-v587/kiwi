    ...
    pub fn new() -> Self {
        Self {
            meta: CmdMeta {
                ...
                arity: -4, // ZINTERSTORE destination numkeys key [key ...] [WEIGHTS weight [weight ...]] [AGGREGATE SUM|MIN|MAX]
...
impl Cmd for ZinterstoreCmd {
    ...
    fn do_cmd(&self, client: &Client, storage: Arc<Storage>) {
        ...
        let result = storage.zinterstore(destination, &keys, &weights, &aggregate);
